        ...
        <div className="md:flex">
          ...
          <div className="md:w-1/2">
            ...
            <div className="flex p-2">
              <div className="w-1/4 p-1">
                <img src={product.imageUrl} alt="Thumbnail 1" className="border border-gray-300 rounded cursor-pointer" />
              </div>
              <div className="w-1/4 p-1">
                <img src="https://images.unsplash.com/photo-1484704849700-f032a568e944" alt="Thumbnail 2" className="border border-gray-300 rounded cursor-pointer" />
              </div>
              <div className="w-1/4 p-1">
                <img src="https://images.unsplash.com/photo-1583394838336-acd977736f90" alt="Thumbnail 3" className="border border-gray-300 rounded cursor-pointer" />
              </div>
              <div className="w-1/4 p-1">
                <img src="https://images.unsplash.com/photo-1487215078519-e21cc028cb29" alt="Thumbnail 4" className="border border-gray-300 rounded cursor-pointer" />
              </div>
            </div>
          </div>
          ...
          <div className="md:w-1/2 p-6">
            <div className="flex justify-between items-start">
              <div>
                ...
                <div className="flex items-center mb-2">
                  ...
                  <span className="text-gray-600 text-sm ml-2">({product.reviewCount} reviews)</span>
                </div>
              </div>
            ...
            <div className="mb-4">
              ...
              <div className="flex space-x-2">
                {colors.map(color => (
                  <button
                    key={color.value}
                    className={`w-8 h-8 ${color.class} rounded-full cursor-pointer ${selectedColor === color.value ? 'border-2 border-primary' : 'border border-gray-300'}`}
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button 
                className="bg-primary text-white px-6 py-2 rounded-lg hover:bg-blue-600 transition flex-grow"
                onClick={handleAddToCart}
              >
                <ShoppingCart className="h-4 w-4 mr-2" /> Add to Cart
              </Button>
              <Button variant="ghost" className="text-gray-600 hover:text-red-500 p-2">
